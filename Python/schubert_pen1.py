...
def funct(x):
    ...
    result = f1 * f2 + ((x[0] + 1.42513)**2 + (x[1] + 0.80032)**2) / 2.0
    return result
...
def grad(x):
    ...
    g1 = -np.sum([(i + 1) * i * np.sin((i + 1) * x[0] + i) for i in range(1, 6)]) * f2 + x[0] + 1.42513
    g2 = -np.sum([(i + 1) * i * np.sin((i + 1) * x[1] + i) for i in range(1, 6)]) * f1 + x[1] + 0.80032
